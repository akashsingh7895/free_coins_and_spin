...
import com.avssolutiion.autoheadshot.databinding.ActivitySpinClaimBinding;

import java.util.Random;

public class SpinClaimActivity extends AppCompatActivity implements MaxAdListener {

    ActivitySpinClaimBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivitySpinClaimBinding.inflate(getLayoutInflater());
                ...
                if (interstitialAd.isReady()){
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            addCoin.commit();
                            startActivity(new Intent(SpinClaimActivity.this,SuccessActivity.class));
